...
#define AMMO_PISTOL_9MM_NATO "pistol_9mm_nato"
#define AMMO_PISTOL_9MM_ALL AMMO_PISTOL_9MM, AMMO_PISTOL_9MM_SOVIET, AMMO_PISTOL_9MM_NATO
#define AMMO_PISTOL_41 "pistol_41"
#define AMMO_PISTOL_45 "pistol_45"
